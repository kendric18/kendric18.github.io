// Kendric Toh — Portfolio Website
// Paste this into Framer → Assets → Code → New Component
// Replace PHOTO_URL with your actual hosted image URL
...
// ─── REPLACE THIS with your hosted photo URL ─────────────────────────────────
const PHOTO_URL = "https://i.imgur.com/placeholder.jpg" // swap in your URL
            ...
            >
                <FadeUp>
                    <div style={{ flex: "1 1 320px" }}>
                        ...
                        >
                            Started with a screwdriver and a saw. Then Interior Design at NAFA, EEE at SP
                            — and now Design & AI at SUTD. Every pivot taught me to think across
                            disciplines.
                        </p>
                        <p
                            style={{
                        ...
                        >
                            VP of Scratch Club. Customer Success at Edgeline Planners. Open to internships
                            in Singapore.
                        </p>
                    </div>
                </FadeUp>
                ...
                <FadeUp>
                    <div style={{ flex: "1 1 260px" }}>
                        ...
                        <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                            {SKILLS.map((skill) => {
                                const isHighlight = skill === "AI / ML"
                                return (
                                    <SkillPill key={skill} highlight={isHighlight}>
                                        {skill}
                                    </SkillPill>
                                )
                            })}
    ...
    return (
        ...
        >
            <FadeUp>
                ...
                >
                    <CTAButton href="mailto:kendric.toh@gmail.com" filled>
                        kendric.toh@gmail.com
                    </CTAButton>
...
// ─── ROOT COMPONENT ───────────────────────────────────────────────────────────
export default function KendricPortfolio() {
    return (
        <div
            style={{
                fontFamily: "Georgia, serif",
...
addPropertyControls(KendricPortfolio, {
    photoUrl: {
